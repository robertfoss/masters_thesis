...
%			anchor=south east
        ...
        \addplot[style={rred,fill=rred,mark=none}]
			coordinates {(BenchA,1.100) (BenchB,1.085) (BenchC,1.092)};
...
%			coordinates {(BenchA,0.74) (BenchB,1.07) (BenchC,1.23)};
    ...
    \end{axis}
\end{tikzpicture}
\caption[Register usage bar chart]{Register usage benchmark for three auto-vectorization alternatives. Results are cumulative for each benchmark.}
\end{figure}
