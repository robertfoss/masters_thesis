...
Each pair is made into a tree, even if the height of that tree would be just one pair. The \textbf{Tree} function constructs a tree node out of a pair. \textbf{AddTreeBranch} is used to append a tree node as a child to another tree node.
\\
